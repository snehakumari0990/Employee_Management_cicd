...
This project is not just a web application; it is a demonstration of a real CI/CD (Continuous Integration / Continuous Delivery) pipeline. Every code push is automatically tested, packaged into a Docker container, pushed to Docker Hub, and deployed, with zero manual steps after `git push`.
